                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="CompraControlador" method="post">
                            ...
                            <button type="submit" class="btn btn-outline-success"><i class="bi bi-floppy"> Guardar</i></button>
                            <a href="CarritoControlador" class="btn btn-outline-info"><i class="bi bi-arrow-return-left"> Volver</i></a>
                        </form>
                    </div>
                </div>
            </div>
