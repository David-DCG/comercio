...
@WebServlet(name = "MainCompra", urlPatterns = {"/MainCompra"})
public class MainCompra extends HttpServlet {
    //Usar este ejemplo para futuros proyectos
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            switch (action) {
                ...
                case "delete":
                    id = Integer.parseInt(request.getParameter("id"));
                    daoCompra.eliminar(id);
                    response.sendRedirect("MainCompra");
                    break;
                case "view":
                    List<Compra> lista = daoCompra.listartodos();
